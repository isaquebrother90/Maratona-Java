...
public class Calculadora {
    ...
    public void somaVarArgs(int... numeros) { // Só pode ter um varargs por assinatura de método
        int soma = 0;                         //Caso haja mais parâmetros, o varargs precisa ser o último
        for(int num : numeros) {
            soma += num;
        }
        System.out.println(soma);
